...
#if defined(__OBJC__)
typedef SWIFT_ENUM(NSInteger, EnxPageSlideEventName, closed) {
...
typedef SWIFT_ENUM(NSInteger, EnxRequiredEventsOption, closed) {
...
typedef SWIFT_ENUM(NSInteger, ParticipantListOptions, closed) {
...
typedef SWIFT_ENUM(NSInteger, RoomSettingOptions, closed) {
